...
import 'package:vdenis/components/task_to_complete_screen.dart';
  ...
  return Dismissible(
    ...
    onDismissed: (direction) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
        content: Text(TaskConstants.tareaEliminada),
        ),
      ); 
    },
    child: Card(
      ...
      child: Center( // Centra horizontalmente el contenido del Card
        child: ListTile(
              ...
              Row(
                children: [
                  CommonWidgetsHelper.buildInfoLines(
                    '$TaskConstants.tipoTarea${task.type}',
                    task.fechaToString(),
                  )
                ],
              ),
          ...
          trailing: Row(
            ...
            children: [
              task.type == TaskConstants.taskTypeUrgent
                  ? const Icon(
                      Icons.warning,
                      color: Colors.red,
                    )
                  : task.type == TaskConstants.taskTypeNormal
                      ? const Icon(
                          Icons.task,
                          color: Colors.blue,
                        )
